...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.feda.FedaPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin feda, com.example.feda.FedaPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.flash_api.FlashApiPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flash_api, com.example.flash_api.FlashApiPlugin", e);
    }
    try {
