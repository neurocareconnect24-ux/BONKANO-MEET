...
import 'package:bonkano_meet/screens/booking/appointment_detail_screen.dart';
...
class PushNotificationService {
  ...
  bool get _isFCMPlatform => Platform.isAndroid || Platform.isIOS || Platform.isMacOS;

// It is assumed that all messages contain a data field with the key 'type'
  Future<void> setupFirebaseMessaging() async {
    if (!_isFCMPlatform) return; // Skip on Windows/Linux
