...
import 'package:bonkano_meet/locale/language_en.dart';
...
/// Returns true if the current platform supports Firebase Messaging (FCM)
  ...
  await Firebase.initializeApp(options: DefaultFirebaseOptions.currentPlatform).then((value) {
    ...
    if (kReleaseMode) {
      try {
        ...
        log('Crashlytics not available on this platform: $e');
      }
    }
  }).catchError(onError);
