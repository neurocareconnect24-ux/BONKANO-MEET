...
import 'package:bonkano_meet/screens/other_patient/model/other_patient_list_res.dart';
import 'package:nb_utils/nb_utils.dart';
import 'package:bonkano_meet/screens/clinic/model/clinics_res_model.dart';
import 'package:bonkano_meet/screens/service/model/service_list_model.dart';

import '../models/base_response_model.dart';
import '../network/network_utils.dart';
import '../screens/Encounter/model/encounter_list_model.dart';
import '../screens/auth/model/login_response.dart';
import '../screens/booking/model/agora_token_res_model.dart';
...
import '../screens/slots/model/available_days_res_model.dart';
...
class CoreServiceApis {
  ...
  static Future<RxList<EncounterElement>> getEncounterList({
    ...
    final encounterListRes = EncounterListRes.fromJson(await handleResponse(await buildHttpResponse("${APIEndPoints.getEncounterList}?per_page=$perPage&page=$page$patientid", method: HttpMethodType.GET)));
  ...
  static Future<AvailableDaysResModel> getAvailableDays({
    required int clinicId,
    required int doctorId,
    required int serviceId,
  }) async {
    final response = await handleResponse(await buildHttpResponse(
      "${APIEndPoints.getAvailableDays}?doctor_id=$doctorId&clinic_id=$clinicId&service_id=$serviceId",
      method: HttpMethodType.GET,
    ));
    return AvailableDaysResModel.fromJson(response);
  }
