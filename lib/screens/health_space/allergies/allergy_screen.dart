...
class AllergyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      appBartitleText: locale.value.allergiesSection,
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        leading: Container(
                          ...
                          decoration: boxDecorationDefault(shape: BoxShape.circle, color: const Color(0xFFF67E7D).withValues(alpha: 0.1)),
                          child: const Icon(Icons.warning_amber_rounded, color: Color(0xFFF67E7D), size: 22),
                        ),
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            4.height,
                            if (item.allergyType.isNotEmpty) Text(item.allergyType, style: secondaryTextStyle(size: 12)),
                            if (item.severity.isNotEmpty) Text(item.severity, style: secondaryTextStyle(size: 12)),
                            if (item.reaction.isNotEmpty) Text(item.reaction, style: secondaryTextStyle(size: 12)),
                          ],
                        ),
                        trailing: IconButton(
      ...
      fabWidget: FloatingActionButton(
        ...
        onPressed: () => Get.to(() => AddAllergyScreen()),
  ...
  Widget _emptyState() {
    return Center(
      child: Column(
        ...
        children: [
          const Icon(Icons.warning_amber_rounded, size: 60, color: secondaryTextColor),
          16.height,
