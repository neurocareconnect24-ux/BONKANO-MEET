...
import '../health_space/health_space_controller.dart';
                        ...
                        (index) {
                          ...
                          return Obx(
                            () => BtmNavItem(
                              ...
                              press: () {
                                // Tabs requiring login: appointment(1), teleconsultation(2), chat(3), healthSpace(4)
                                if (!isLoggedIn.value && (index >= 1 && index <= 4)) {
                                  doIfLoggedIn(() {
  ...
  void handleChangeTabIndex(int index) {
    ...
    try {
      if (index == 0) {
        ...
        // Encounters/Consultations - data loaded by the screen itself
      } else if (isLoggedIn.value && index == 3) {
        HealthSpaceController hsCont = Get.find();
        hsCont.loadAllData();
      }
