...
import 'package:bonkano_meet/components/appointment_detail_applied_tax_list_bottom_sheet.dart';
import 'package:bonkano_meet/screens/booking/components/cancellations_booking_charge_dialog.dart';
import 'package:bonkano_meet/screens/booking/components/rescheduling_component.dart';
                      ...
                      child: payNowBtn(context).visible(
                        (appointmentDetailCont.appointmentDetail.value.paymentStatus.toLowerCase().contains(PaymentStatus.pending) ||
                                ...
                                (appointmentDetailCont.appointmentDetail.value.status.toLowerCase().contains(StatusConst.checkIn.toLowerCase()) ||
                                    appointmentDetailCont.appointmentDetail.value.status.toLowerCase().contains(StatusConst.pending.toLowerCase()) ||
                                    appointmentDetailCont.appointmentDetail.value.status.toLowerCase().contains(StatusConst.confirmed.toLowerCase())) ||
