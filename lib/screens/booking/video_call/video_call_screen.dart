...
class VideoCallScreen extends StatelessWidget {
  ...
  Widget _buildRemoteVideo() {
    ...
    // Waiting for doctor placeholder
    return Container(
          ...
          children: [
            ClipRRect(
              ...
              child: CachedImageWidget(
                url: videoCallCont.appointment.doctorImage,
                height: 120,
                width: 120,
                fit: BoxFit.cover,
                circle: true,
            ...
            24.height,
            Text(
              videoCallCont.appointment.doctorName,
              style: boldTextStyle(size: 22, color: Colors.white),
            ),
            12.height,
            Text(
              videoCallCont.appointment.serviceName,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      4.height,
                      Text(
                        locale.value.videoConsultation,
