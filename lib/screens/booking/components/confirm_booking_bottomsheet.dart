...
import 'package:bonkano_meet/components/cached_image_widget.dart';
...
import 'package:bonkano_meet/utils/price_widget.dart';
            ...
            children: [
              AppButton(
                ...
                child: FittedBox(
                  ...
                  child: Text(locale.value.cancel, style: boldTextStyle(color: isDarkMode.value ? white : blackColor, size: 14)),
                ),
              ).expand(),
              32.width,
              AppButton(
                ...
                child: FittedBox(
                  fit: BoxFit.scaleDown,
                  child: Text(locale.value.continueText, style: appButtonTextStyleWhite),
                ),
              ).expand(),
            ],
