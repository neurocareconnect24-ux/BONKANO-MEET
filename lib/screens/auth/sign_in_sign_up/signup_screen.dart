...
import 'package:bonkano_meet/components/app_logo_widget.dart';
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Obx(
                          () => AppTextField(
                            ...
                            focus: signUpController.phoneCodeFocus,
                            nextFocus: signUpController.mobileFocus,
                    ...
                    16.height,
                    AppTextField(
                      title: "${locale.value.email} (${locale.value.optional})",
                      textStyle: primaryTextStyle(size: 12),
                    ...
                    AppButton(
                      ...
                      child: FittedBox(
                        ...
                        child: Text(locale.value.signUp, style: appButtonTextStyleWhite),
                      ),
                    ),
                  ],
                ),
